...
async def test_force_reconnect_preserves_paper_cash(tmp_path):
    ...
    book.write_text(
        '{"cash": 193.44, "equity": 193.44, "day_start_equity": 200.0, '
...
def test_format_mode_reply():
    assert format_mode_reply(paper=True, cash=193.44, equity=193.44).startswith("MODE: PAPER")
    assert "193.44" in format_mode_reply(paper=True, cash=193.44, equity=193.44)
