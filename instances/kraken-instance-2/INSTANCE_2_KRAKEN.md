...
|----------|-------------|-------------|
| Working dir | repo-root Coinbase checkout | `instances/kraken-instance-2/` (this folder) |
...
# edit WorkingDirectory / ExecStart / EnvironmentFile / User to instances/kraken-instance-2
